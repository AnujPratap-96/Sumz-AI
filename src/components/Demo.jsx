    ...
    <section className="mt-16 w-full max-w-xl">
      ...
      {allArticles.map((item , index) => (
       ...
       key={`link-${index}`}
        ...
        <img src={copied === item.url ? tick : copy} alt="copyIcon" 
        ...
        isFetching ? (
          ...
          article.summary && (
            <div className="flex flex-col gap-3">
             <h2 className="font-satoshi font-bold text-xl text-gray-600">Article <span className="blue_gradient">Summary</span></h2>
